...
const Credentials: React.FC<CredentialsProps> = ({ creators = [] }) => {
  ...
  const handleAddCredential = async (credential: Omit<Credential, 'id'>) => {
    try {
      ...
      if (!insertData.creator_id) {
        delete insertData.creator_id;
      }
    ...
    <div className="max-w-7xl mx-auto pt-16 lg:pt-0">
      ...
      <div className="flex flex-wrap gap-4 mb-6">
        ...
        >
          ...
          {activeTab === 'creator' && <option value="creator">Sort by Creator</option>}
        </select>
      </div>
      ...
      {showModal && (
        <CredentialModal
          ...
          onSave={selectedCredential ? handleEditCredential : handleAddCredential}
        />
      )}
    </div>
  );
