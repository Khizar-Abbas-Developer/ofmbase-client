/*
  ...
  1. Changes
    - Add agency creation for agency type users
    - Add better error handling and logging
    - Add transaction to ensure atomic operations

  2. Notes
    - Creates agency record automatically for agency type users
...
BEGIN
  ...
  BEGIN
    ...
    -- Create agency record for agency type users
